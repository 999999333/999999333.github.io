    ...
    EXEC('create view "dbt"."visit_report__dbt_tmp_temp_view" as 
...
visit_with_db_ids as (
    select * from "DWH_Fabric"."dbt"."fact_visit"
...
select * from final;');
      ...
      EXEC('CREATE TABLE "dbt"."visit_report__dbt_tmp" AS (SELECT * FROM "dbt"."visit_report__dbt_tmp_temp_view");');
    ...
    EXEC('DROP view IF EXISTS "dbt"."visit_report__dbt_tmp_temp_view";');
