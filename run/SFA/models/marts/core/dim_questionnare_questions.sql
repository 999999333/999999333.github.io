    ...
    EXEC('create view "dbt"."dim_questionnare_questions__dbt_tmp_temp_view" as 
...
select * from final;');
      ...
      EXEC('CREATE TABLE "dbt"."dim_questionnare_questions__dbt_tmp" AS (SELECT * FROM "dbt"."dim_questionnare_questions__dbt_tmp_temp_view");');
    ...
    EXEC('DROP view IF EXISTS "dbt"."dim_questionnare_questions__dbt_tmp_temp_view";');
