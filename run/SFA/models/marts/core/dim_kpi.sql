    ...
    EXEC('create view "dbt"."dim_kpi__dbt_tmp_temp_view" as 


with kpi as (
    select * from "DWH_Fabric"."dbt"."stg_sfa__kpis"
),
...
select * from final;');
      ...
      EXEC('CREATE TABLE "dbt"."dim_kpi__dbt_tmp" AS (SELECT * FROM "dbt"."dim_kpi__dbt_tmp_temp_view");');
    ...
    EXEC('DROP view IF EXISTS "dbt"."dim_kpi__dbt_tmp_temp_view";');
