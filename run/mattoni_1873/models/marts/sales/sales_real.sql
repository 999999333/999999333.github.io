...
final as (
        ...
        (
            select
                cast(''"L50_SB_Vitek"."sfa"."int_kmv_documents_closed_enhanced"'' as VARCHAR(MAX)) as _dbt_source_relation,
            ...
            from "L50_SB_Vitek"."sfa"."int_kmv_documents_closed_enhanced"
        ...
        (
            select
                cast(''"L50_SB_Vitek"."sfa"."int_pepsi_documents_closed_enhanced"'' as VARCHAR(MAX)) as _dbt_source_relation,
            ...
            from "L50_SB_Vitek"."sfa"."int_pepsi_documents_closed_enhanced"
