  ...
  merge into "L50_SB_Vitek"."snapshots"."sfa__document_items_snapshot" as DBT_INTERNAL_DEST
    using "L50_SB_Vitek"."snapshots"."#sfa__document_items_snapshot__dbt_tmp" as DBT_INTERNAL_SOURCE
