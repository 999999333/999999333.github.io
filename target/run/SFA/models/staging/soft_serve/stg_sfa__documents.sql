    ...
    EXEC('create view "dbt"."stg_sfa__documents__dbt_tmp" as with source as (
    select * from "DWH_Fabric"."snapshots"."sfa__documents_snapshot"
),
...
case
 ...
 as country_id,
        ...
        "Details" as document_details,
        "Country_Code" as country_code,
        "ExternalCode" as external_code,

        ----------  numerics
        "PassScore" as document_pass_score,
